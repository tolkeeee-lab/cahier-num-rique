        ...
        {pens.map((pen) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-mono font-extrabold transition-all duration-200 flex-shrink-0 border cursor-pointer ${
                isSelected
