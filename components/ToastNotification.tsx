    ...
    switch (type) {
      case 'success':
        return {
          ...
          icon: <CheckCircle2 className="w-5 h-5 text-emerald-400 flex-shrink-0" strokeWidth={1.75} />,
        }
      case 'error':
        return {
          bg: 'bg-rose-900/95 text-white border-rose-700',
          icon: <XCircle className="w-5 h-5 text-rose-400 flex-shrink-0" strokeWidth={1.75} />,
        }
      case 'warning':
        return {
          bg: 'bg-amber-900/95 text-white border-amber-700',
          icon: <AlertTriangle className="w-5 h-5 text-amber-400 flex-shrink-0" strokeWidth={1.75} />,
        }
      case 'info':
      default:
        return {
          bg: 'bg-gray-900/95 text-white border-gray-700',
          icon: <Info className="w-5 h-5 text-blue-400 flex-shrink-0" strokeWidth={1.75} />,
        }
    }
  }
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="p-1 opacity-60 hover:opacity-100 transition-all rounded-full hover:bg-white/10 cursor-pointer active:scale-[0.97]"
      >
