...
const THEMES: Record<string, {
  ...
  particulier: {
    filters: [
      { id: 'all', label: 'Tout', emoji: '🌟' },
      { id: 'foyer', label: 'Maison & Charges', emoji: '🏠' },
      { id: 'alimentaire', label: 'Marché & Nourriture', emoji: '🛒' },
      { id: 'scolarité', label: 'École & Enfants', emoji: '📚' },
      { id: 'finance', label: 'Finance & Tontine', emoji: '🤝' },
      { id: 'autre', label: 'Divers', emoji: '🏷️' }
    ]
  }
}
...
export default function JournalPage() {
  ...
  const FILTERS = getFilters(shopActivity)
